...
\begin{document}
  ...
  \chapter{Nutrition}
	...
	that it should depend on mass and body fat percentage. When people say they have a fast or slow metabolism I take it with a pinch of salt, because I know it should mostly depend
        ...
        \footnote{\href{https://docs.google.com/spreadsheets/d/1DPH4OQuc6yQf3TdUI1D3m1t4UGaiRP1ptWh5f9Y9Y2U/edit?usp=sharing}{Meal Plan Calculator on Google Spreadsheets}}.
  ...
  \chapter{Workout}
	...
	\end{figure}
        ...
        and also watch you perform so that he can give you feedback. If you don't know such a person, I know some gyms have induction days when they can show you
        different exercises. As a last resort, there are a lot of helpful youtube channels out there showing you the correct technique for these exercises, such as
        Athlean-X, Buff Dudes, Jeff Nippard, ScottHermanFitness etc. Just search on their channel the exercise name and you should find something.
        ...
        What I recommend if you do look at videos first, you should start with really low weights at first, until you feel like you got the form right.
        ...
        Another thing I want to mention is that when you're doing a specific exercise, you have to focus on the muscles it should train. For example, if you do bench press
        ...
        \footnote{\href{https://www.youtube.com/watch?v=Ip25pzb-wdU}{Jeff Nippard on mind-muscle connection}}
        ...
        and push up. When performing this exercise first make sure the bar is centered compared to the bench (and not more on the right or left), then just sit on your back on the bench
        ...
        touch the ring on the bar. One last thing about the technique is that you should have your feet stable on the ground, slightly behind your knees 
        ...
        Apart from the flat version you can also do it on an incline (it hits upper pectoral muscles better) or a decline (lower chest) and also with the dumbbells instead of barbell.
        Using dumbbells will make sure both hands are doing same amount of work during the exercise. You can also find bench press machines in the gym,
        there's a few differences between them. First difference is that when exercising with a barbell you're also balancing the bar, pushing with both hands at the same speed.
        ...
        Normally when performing heavy lifts with barbells it's good to have someone that can help you in case you can't push it anymore (this is called a spotter). People lost their lives
        after they couldn't push the bar up and it landed on their neck.
        ...
        --- another popular exercise. Also called the military press or just shoulder press with the barbell. In this exercise you push the bar above your head, working mostly the
        deltoid. It considered a compound exercise, training the core as well. For this exercise you have a rack that can hold the barbell high, close to your neck area. You pick up
        the barbell, put it on your chest under your head. You grip the barbell shoulder width apart. You start by moving your head backwards a little, leaving room for the barbell to go up.
        ...
        Place your feet underneath the barbell so that they are sticking on the other side. They should be on the same line with your hips. Grab the bar just outside your legs. 
        There's different grips you can use, for example the overhand grip (or normal grip). If you start lifting really heavy weights with this grip you might start feeling that the
        bar is rolling outside your palm. This is why people use a mixed grip (one hand with the palm facing towards you and the other one outside). If you start using a mixed grip,
        ...
        While the deadlift is one of the most famous exercises out there, it's not exactly needed to build a good physique. There's a lot of good leg \& back exercises out there you can do, instead
        ...
        deadlift. This is one of the reasons this is such a popular lift.
        ...
        --- really famous compound exercise for lateral muscles (back) and biceps. It's a really common exercise in calisthenics. You have a bar above your head that you grip with your palms facing
        ...
        If you want more chest activation you bend more to the front. If you want more tricep activation you keep your back straight. Similar to pull-ups, there are machines to
        ...
        --- another exercise for the back and biceps. You sit in a similar position when you start a deadlift, but with much lower weight and you just use your arms to bring the barbell to your body.
        ...
        with every movement. For the bicep curl, you also train forearms a bit, since it's used to stabilize the wrist while you pull up the dumbbell.
        ...
        --- another isolation exercise, this time for the triceps.
        ...
        Abs exercises
        - sit ups, bicycle, hanging leg raises
        

        Reiteration, by muscle group
        ...
        // mention mind-muscle connection

        // mention why the form is important --- avoid injuries

        // mention optimal weights for bench pressing, squatting, etc -> compared to bodyweight
