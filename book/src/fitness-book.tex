...
However, DEXA scans can have errors too, and a lot of people talk against it\footnote{\href{https://www.youtube.com/watch?v=2Gg4Jm5KS1Y}{Greg Doucette on DEXA Scans on Youtube}}\footnote{\href{https://www.youtube.com/watch?v=P17bcpYE8Ew}{Brain Shaw on DEXA Scans on Youtube}}. The scan is also expensive, I did it in London at bodyscan for roughly \pounds 100.
	...
	that it should depend on mass and body fat percentage. When people say they have a fast or slow metabolism I take it with a pinch of salt, because I know it should mostly depend
        ...
        don't need to track anymore. This option worked really well for me, and I felt like it saved me a lot of time. However, not everyone enjoys doing this, making a meal
	...
	\begin{figure}[h]
		...
		\caption{An example of a meal plan I made for cutting down. I used to track carbs \& fat but no anymore}
		\label{fig3}
	\end{figure}
        ...
        this process is happening, even if you don't eat that many calories.
        I tried cooking such meals and I agree that some of them are super filling. For example egg whites are
        ...
        (a lot of high protein ice creams recipes, as you can see in Figure \ref{fig4}),
	...
	\end{figure}
        ...
        ice cream, even low fat peanut butter all while cutting. I can make a small pizza for less than 300 calories using 
        ...
        good and looks amazing (Figure \ref{fig5}).
