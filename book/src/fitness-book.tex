...
\begin{document}
  ...
  \chapter{Workout}
	...
	\end{figure}
        ...
        just to have a good overview in Figure \ref{fig10}
  ...
  \footnote{\href{https://join.slack.com/t/fitness-world-group/shared_invite/zt-1bhw1fakw-X5vr_m1DwEv2tAelIcWj1w}{Slack invite for Fitness World group}}.
  	...
  	\section{News}
        ...
        Taking part in a competition can be a great motivation to stay on track with your progress! There's bodybuilding competitions and also powerlifting ones.
