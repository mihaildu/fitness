...
However, DEXA scans can have errors too, and a lot of people talk against it\footnote{\href{https://www.youtube.com/watch?v=2Gg4Jm5KS1Y}{Greg Doucette on DEXA Scans on Youtube}}\footnote{\href{https://www.youtube.com/watch?v=P17bcpYE8Ew}{Brain Shaw on DEXA Scans on Youtube}}. The scan is also expensive, I did it in London at bodyscan for roughly \pounds 100.
	...
	\end{figure}
        ...
        I take some of these supplements myself, however I never tested what actually works and what not since I'm getting results anyway and it's hard to tell what really made a difference.
        Other type of supplements are the one supposed to help you with recovery, since a lot of people struggle with this. Again I can't testify for any of these products and will just
        ...
        high in protein such as milk, eggs, meat and so on. From these 9 amino acids, 3 of them are branched-chain amino acid: leucin, isoleucine and valine. People say these 3 amino acids
        ...
        Glutamine\footnote{\href{https://www.healthline.com/nutrition/glutamine}{Glutamine on Healthline}} --- this is another amino acide, making up proteins just like BCAAs. However Glutamine is
        ...
        showing it works, every bodybuilder I watched also approves of it. I take it as well, however I can't say how much it helped me. When I started taking it I was doing a bulk, relatively
        early in my lifting career so I was increasing the weight in the gym quite frequently anyway. Creatine is stored inside your muscle, and it's used with glycogen and fat to produce
        adenosine triphosphate (ATP) which makes your muscle contract. Taking it as a supplement should help with ATP production, which should give you more strength and endurance in the gym.
        ...
        % you can find creatine in foods too (tuna, meat etc) (notes)

        % mention creatine loading (notes)
        
        % mention creatine - hair loss + videos + paper (notes)
