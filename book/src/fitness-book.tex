...
However, DEXA scans can have errors too, and a lot of people talk against it\footnote{\href{https://www.youtube.com/watch?v=2Gg4Jm5KS1Y}{Greg Doucette on DEXA Scans on Youtube}}\footnote{\href{https://www.youtube.com/watch?v=P17bcpYE8Ew}{Brain Shaw on DEXA Scans on Youtube}}. The scan is also expensive, I did it in London at bodyscan for roughly \pounds 100.
	...
	that it should depend on mass and body fat percentage. When people say they have a fast or slow metabolism I take it with a pinch of salt, because I know it should mostly depend
        ...
        don't need to track anymore. This option worked really well for me, and I feel like it saves me a lot of time. However, not everyone enjoys doing this, making a meal
        plan is not straightforward and takes time to perfect and unless you try really hard to diversify it, it might be hard to add something spontaneous to it by swapping
        a meal with something that has more or less the same calories. I personally don't care that much to eat something completely new every single day and I think most
        people don't either, they would have the same meals every other day.
        ...
        I can adjust the amount of each type of food and it will automatically add the nutritional values. Once I hit how many calories and proteins I need in a day, I call
        that a day meal plan. I made a copy of my meal plan calculator spreadsheet available for everyone online
        ...
        bottom right then keep adjusting the units in the calculator until you hit your goals!

        It might be difficult to decide what amount to use for each type of food, I started from experience (e.g. a typical chicken breast meal I would buy
        from the supermarket would have around 200g of chicken breast and 250g of rice or something similar). I also had to take into account the preparation process for these
        ...
        and split into 5. If I ended up in my table with a random odd number for the amount of chicken breast in a day (something like 167g), then buying for the week would be
        impossible. So there is a bit of tweaking the numbers until you get everything right. If you want to have different meals on different days you repeat the process until
        you have something planned to eat for each day. In my case I don't mind eating the same thing Monday to Friday, so I cook 5 times the food I would eat in a day every
        ...
        I do it, which I think it's really fast and for me it tastes good too. For example in my cutting meal plan I have a few dishes that require cooking: the classic chicken,
        rice and broccoli dish, salmon with bread and vegetables and eggs. I usually buy frozen broccoli/vegetables so I just need to heat them up in the microwave before eating.
        This means I still have to cook the rice, chicken breast and salmon. For both the chicken breast and salmon I use a slow cooker. I would buy 1kg of chicken breast, wash it,
        put it in the slow cooker with a bit of water and leave it on high for 4h (you could do 6h on low but at the end of the day it depends, you can tweak the timer after you see
        how long it normally takes). After the chicken breast is cooked I just split it into 5 portions (for Monday to Friday). I use a kitchen scale to split it as equal as possible,
        but sometimes I don't have time for this so I just eyeball it. I do the same with the salmon (500g in my case), for which I don't add any water. I don't use seasoning but you
        can use if you really want. I use Frank's Red Hot sauce \footnote{\href{https://www.franksredhot.com/}{Frank's Red Hot Website}} to season these 2 meals since it has almost
        no calories and it's like liquid salt with a bit of spice.
