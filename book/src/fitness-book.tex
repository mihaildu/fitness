...
\begin{document}
  ...
  \chapter{Workout}
	...
	\end{figure}
        ...
        muscle runs out of ATP) or because you just want to stop, still having reps in the tank. When you stop you've just finished a set. The number of reps in a set and the total sets you do for each
        exercise over the course of a week represents your workout plan. There is no perfect workout plan out there, just like for dieting and opinions are really different on how you should train, coming
        from different people in the fitness industry. At the end of the day you still have to try different workout plans and see what works best for you and what gives you the best results.

        First, let's look at the number of reps in a set. The most common idea out there is you should do a different number of reps based on your goal: maximum increase in strength, muscle size or
        ...
        for an exercise, as heavy as you possibly can. So I do think it's important to train to failure here, you should adjust the weight such that your 5th rep is almost a failure.
        ...
        Training to failure is also known as workout intensity. So, should you train to failure for muscle growth? There are different opinions about this, some say training to failure is not optimal
        ...
        \footnote{\href{https://www.healthline.com/health/fitness/rest-between-sets#for-strength-and-power}{Rest time on healthline}}. Honestly I wouldn't stress too much about rest time, just try
        not to do one set after the other too fast since you are not doing cardio with the weights, and also don't wait way too long between sets since youre muscles are warmed up and ready to go.
        ...
        MPS to end before training it again, so that the muscle fibers are completely repaired. In this theory, after the 36h (or sometimes 48h) have passed, the muscle is just resting, so to optimally
        ...
        With all of this in mind, let's look at some workout plans, also referred to as splits
        \footnote{\href{https://www.youtube.com/watch?v=RDWyqnGhmWY}{ATHLEAN-X on workout splits on YouTube}}. The first split I'm going to discuss is the \textbf{full body split}. In workout plan
        ...
        Full body split
        too long, since you have at least 9 muscle groups you want to train, and for each you want to do more than 3 sets. Finishing all your sets would take you hours and not everyone has this much time
        to workout in a day, or even the energy for it.
        - arnold was doing this??

        \textbf{Push, pull, legs} --- probably the most famous split out there. This combines muscles used for the same movements together, and allows you to let them rest before having the same
        ...
        - shoulders, chest, triceps, back, biceps, legs, rest on sunday
        - chest, back, legs (push), shoulders, arms, legs (pull)
        ...
        with a push, pull, legs \& abs split, train only 9 major muscle groups for start (), hit each twice a week with a total of 6 sets of 10-12 reps (aim for 40 seconds of TUT). If you do
        everything right (nutrition as well), this should give you good results. As you keep training, every now and then you might want to try a new exercise or change any of the following: volume,
        intensity, TUT, reps or frequency. I know it's difficult because progress is slowing down after a while anyway, but try to see what works best for you. I put a workout plan example below, feel
        free to access it from the link and copy the spreadsheet to your own account and update with your own exercises. Adjust the weight so that you hit the 10-12 reps range. Increase weight over time
        if it's becoming too easy with the same weight. After longer periods of time add more sets, either to the same exercises or newer exercises that hit the same muscle group.

        Mention warm-up set, avoiding injuries, getting a pump etc.
        Mention streching, ice baths etc
        Mention drop-set vs increasing weight

        at the end: training each muscle group twice a week, with 8 sets each time?? -> 16 sets

        give example: chest - 4 sets of bench, 4 sets of pec fly = 8 sets in a day, twice a week = 16 sets a week
